...
// Featured flagship (first in data array, Building status)
const featuredProject = projects[0]
// Two completed previews to show alongside the flagship (MARS + PharmaAI)
const completedPreviews = projects.filter((p) => p.status === 'Completed').slice(0, 2)
      ...
      <div className="px-6 md:px-10 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-14">
          ...
          {completedPreviews.map((project, i) => (
            ...
            >
              <PortfolioCard project={project} forceRegular />
            </motion.div>
          ))}
        </div>
